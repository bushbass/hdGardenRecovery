...
function ListAll() {
  ...
  const getNeeded = async () => {
    const response = await fetch(`${process.env.REACT_APP_BACKEND_URL}needed`)
    console.log(response)
    setToggle(!toggle)
    console.log(toggle)
  }
  ...
  return (
    <div className='list-all'>
      {loading ? (
        <>
          <h3>
            This app runs on a free server that goes to sleep after periods of
            inactivity
            <br />
        ...
        <div className='products'>
          <div className='sortingNav'>
            ...
            <div onClick={getNeeded} className='categoryChoice'>
              Needed
            </div>
